  ...
  lessons: [
    {
      ...
      <p>Reprenons un cas avec plusieurs opérations mélangées : calcule A = (−12) + (+7) − (−5) − (+3). On transforme d'abord les soustractions en additions de l'opposé : A = (−12) + (+7) + (+5) + (−3). On regroupe : positifs (+7)+(+5)=+12, négatifs (−12)+(−3)=−15, donc A = (+12)+(−15) = −3. Sur une droite graduée, (−3) se situe entre −4 et −2, plus proche de zéro que (−12) : comparer deux relatifs, c'est comparer leur position sur cette droite, le plus à droite étant toujours le plus grand.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Rappel des règles de calcul sur les puissances, indispensables pour aller vite : aⁿ × aᵐ = aⁿ⁺ᵐ (on additionne les exposants), aⁿ ÷ aᵐ = aⁿ⁻ᵐ (on soustrait), et (aⁿ)ᵐ = aⁿˣᵐ (on multiplie). Exemple complet : (2³)² × 2⁴ ÷ 2⁵ = 2⁶ × 2⁴ ÷ 2⁵ = 2¹⁰ ÷ 2⁵ = 2⁵ = 32. Retiens aussi que a⁰ = 1 (pour a ≠ 0) et a⁻ⁿ = 1/aⁿ.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple complet d'addition de fractions à dénominateurs différents : calcule 2/3 + 5/6. Le plus petit dénominateur commun est 6 (car 6 = 2×3), donc 2/3 = 4/6, et 4/6 + 5/6 = 9/6, qu'on simplifie en 3/2 (en divisant par le PGCD 3). Pour multiplier deux fractions, on multiplie numérateurs entre eux et dénominateurs entre eux ; pour diviser, on multiplie par l'inverse de la seconde fraction.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple pas à pas : développe et réduis E = 3(x + 2) − 2(x − 5). On distribue chaque terme : E = 3x + 6 − 2x + 10 (attention au signe − qui change le signe de chaque terme entre parenthèses), puis on réduit les termes semblables : E = x + 16. Pour factoriser dans l'autre sens, on cherche le facteur commun : 6x + 9 = 3(2x + 3), car 3 divise à la fois 6 et 9.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple d'application : dans un triangle ABC, M est sur [AB] et N sur [AC], avec (MN) parallèle à (BC). On sait AM = 3 cm, AB = 7,5 cm et AC = 10 cm. D'après Thalès : AM/AB = AN/AC, donc 3/7,5 = AN/10, d'où AN = (3×10)/7,5 = 4 cm. On procède toujours de la même façon : on identifie le triangle, on écrit les rapports égaux, puis on résout l'égalité comme une proportion (produit en croix).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple d'application : dans un triangle ABC rectangle en A, on a AB = 6 cm et AC = 8 cm ; calculons BC. D'après Pythagore : BC² = AB² + AC² = 6² + 8² = 36 + 64 = 100, donc BC = √100 = 10 cm. Si on connaît l'hypoténuse et un côté, on isole plutôt le côté cherché : par exemple si BC = 10 et AB = 6, alors AC² = BC² − AB² = 100 − 36 = 64, donc AC = 8 cm.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple avec l'inconnue des deux côtés : résous 4x + 5 = 2x + 17. On regroupe les x d'un côté en soustrayant 2x aux deux membres : 2x + 5 = 17, puis on isole x en soustrayant 5 : 2x = 12, et enfin on divise par 2 : x = 6. La méthode est toujours la même : on simplifie chaque membre, on rassemble les inconnues d'un côté et les nombres de l'autre, puis on divise par le coefficient de x.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple de simplification : simplifie √72. On cherche le plus grand carré parfait qui divise 72 : 72 = 36 × 2, et 36 est un carré parfait (6²), donc √72 = √36 × √2 = 6√2. Autre exemple utile : √50 + √18 = 5√2 + 3√2 = 8√2 (on ne peut additionner des racines que si le nombre sous la racine, une fois simplifié, est le même).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple de calcul de moyenne à partir d'un tableau d'effectifs : pour les notes 8 (effectif 2), 12 (effectif 5), 16 (effectif 3), la moyenne est (8×2 + 12×5 + 16×3) / (2+5+3) = (16+60+48)/10 = 124/10 = 12,4. La fréquence d'une valeur est son effectif divisé par l'effectif total, souvent exprimée en pourcentage : ici, la fréquence de la note 12 est 5/10 = 50 %.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple d'application avec des droites parallèles coupées par une sécante : si deux droites parallèles sont coupées par une sécante, les angles alternes-internes sont égaux, tout comme les angles correspondants. Exemple : si un angle mesure 65°, l'angle alterne-interne de l'autre côté de la sécante mesure aussi 65°, et l'angle qui lui est supplémentaire (sur la même droite) mesure 180° − 65° = 115°.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple d'application : dans un triangle ABC rectangle en A, l'angle en B mesure 30°, et l'hypoténuse BC = 8 cm. On cherche AB (le côté adjacent à l'angle B). On utilise cos(B) = AB/BC, donc AB = BC × cos(B) = 8 × cos(30°) ≈ 8 × 0,866 ≈ 6,93 cm. Pour trouver un angle à partir de deux côtés connus, on utilise la fonction inverse (cos⁻¹) à la calculatrice.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple de calcul composé : un solide est formé d'un pavé droit (5 cm × 4 cm × 3 cm) surmonté d'un cube d'arête 2 cm. Volume du pavé : 5×4×3 = 60 cm³ ; volume du cube : 2³ = 8 cm³ ; volume total : 60 + 8 = 68 cm³. Pour une figure composée, il faut toujours décomposer en formes simples (rectangle, triangle, cercle, pavé, cube...), calculer chaque aire ou volume séparément, puis additionner (ou soustraire si une partie est retirée).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple pour transformer un nombre décimal en fraction puis simplifier : 0,75 = 75/100 = 3/4 (en divisant par 25, le PGCD de 75 et 100). Pour ranger des rationnels dans l'ordre, il est souvent plus simple de les convertir en une écriture décimale : par exemple, pour comparer 5/8, 0,6 et 7/10, on calcule 5/8 = 0,625, ce qui donne l'ordre croissant : 0,6 < 5/8 < 7/10.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple complet : un pavé droit mesure 6 cm de longueur, 4 cm de largeur et 5 cm de hauteur. Volume : V = 6×4×5 = 120 cm³. Aire totale : il a 3 paires de faces identiques, d'aires (6×4), (6×5) et (4×5), donc aire totale = 2×(24+30+20) = 2×74 = 148 cm². Le patron du pavé (les 6 rectangles à plat) permet de visualiser et de vérifier chacune de ces faces avant de calculer.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple de calcul de pourcentage d'évolution : un article coûtait 8000 F CFA et coûte maintenant 9200 F CFA. L'augmentation est de 9200 − 8000 = 1200 F CFA, soit un pourcentage d'augmentation de (1200/8000) × 100 = 15 %. Pour appliquer directement un pourcentage, on multiplie par le coefficient multiplicateur : une hausse de 15 % revient à multiplier par 1,15 (et une baisse de 15 % revient à multiplier par 0,85).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple de construction avec les coordonnées : dans un repère, soit A(2 ; 3) et O(0 ; 0) le centre de symétrie. L'image A' de A par la symétrie de centre O a pour coordonnées A'(−2 ; −3) — on prend l'opposé de chaque coordonnée. Plus généralement, si O a pour coordonnées (xO ; yO), l'image de M(x ; y) est M'(2xO − x ; 2yO − y).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple de calcul de coordonnées d'un vecteur : soit A(1 ; 2) et B(4 ; 6). Les coordonnées du vecteur AB sont (xB − xA ; yB − yA) = (4−1 ; 6−2) = (3 ; 4). Pour trouver l'image A' d'un point A par une translation de vecteur u(a ; b), on ajoute simplement les coordonnées : A' a pour coordonnées (xA + a ; yA + b).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Propriété complémentaire utile : l'angle inscrit dans un cercle est égal à la moitié de l'angle au centre qui intercepte le même arc. Exemple de calcul : pour un cercle de rayon 5 cm, la circonférence est C = 2 × π × r ≈ 2 × 3,14 × 5 ≈ 31,4 cm, et l'aire du disque est A = π × r² ≈ 3,14 × 25 ≈ 78,5 cm².</p>`,
      quiz: [
  ...
  lessons: [
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>La lumière se propage en ligne droite (propagation rectiligne) tant qu'elle reste dans un même milieu transparent homogène — c'est ce qui explique qu'un objet opaque placé devant une source lumineuse crée une zone d'ombre nette derrière lui. On distingue une source primaire (qui produit sa propre lumière, comme le Soleil ou une ampoule) d'une source secondaire (qui ne fait que renvoyer la lumière qu'elle reçoit, comme la Lune ou une page de livre).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>On distingue un mélange homogène (on ne distingue aucun constituant à l'œil nu, comme l'eau salée) d'un mélange hétérogène (on distingue plusieurs constituants, comme l'eau et l'huile). Pour séparer les constituants d'un mélange, on utilise différentes techniques selon le cas : la filtration (pour séparer un solide non dissous d'un liquide), la décantation (laisser reposer pour que les phases se séparent par densité) ou la distillation (pour séparer deux liquides miscibles selon leur température d'ébullition).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>À l'échelle microscopique, les trois états de la matière se distinguent par l'agitation et l'espacement des molécules : à l'état solide, les molécules sont très proches et peu mobiles (arrangement ordonné) ; à l'état liquide, elles sont proches mais peuvent glisser les unes sur les autres ; à l'état gazeux, elles sont très espacées et se déplacent librement dans tout l'espace disponible. C'est cette agitation croissante qui explique pourquoi un gaz occupe tout le volume du récipient qui le contient, contrairement à un solide ou un liquide.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Dans un circuit en série, tous les composants sont branchés les uns à la suite des autres : si on en retire un, tout le circuit s'arrête (le courant ne peut plus circuler). Dans un circuit en dérivation (parallèle), chaque composant est branché sur une boucle indépendante : si on en retire un, les autres continuent de fonctionner. Un court-circuit se produit quand le courant trouve un chemin de résistance quasi nulle, ce qui provoque une intensité dangereusement élevée — d'où l'importance des fusibles et disjoncteurs.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple de calcul : un objet a une masse de 270 g et un volume de 100 cm³. Sa masse volumique est ρ = m/V = 270/100 = 2,7 g/cm³ (c'est justement la masse volumique de l'aluminium). Comme cette valeur est supérieure à celle de l'eau (1 g/cm³), cet objet coulerait dans l'eau. Pour retrouver la masse à partir de la masse volumique et du volume, on utilise m = ρ × V.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Une combustion complète (assez de dioxygène) produit du dioxyde de carbone (CO₂) et de l'eau, avec une flamme généralement bleue et propre ; une combustion incomplète (pas assez de dioxygène) produit en plus du monoxyde de carbone (CO, gaz toxique et invisible) et de la suie (fumée noire), avec une flamme plus jaune/orange. Pour vérifier la présence de CO₂, on utilise l'eau de chaux : elle se trouble (devient blanche laiteuse) en présence de dioxyde de carbone.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple de mesure : pour mesurer la tension aux bornes d'une lampe, on branche un voltmètre EN DÉRIVATION directement sur les bornes de cette lampe (jamais en série, car sa résistance très élevée empêcherait presque tout le courant de passer). Si un générateur de 9 V alimente deux lampes identiques en série, chaque lampe reçoit environ 4,5 V (la tension se partage), alors qu'en dérivation, chaque lampe recevrait directement les 9 V du générateur.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple de calcul avec la loi d'Ohm U = R × I : un conducteur de résistance 20 Ω est traversé par un courant d'intensité 0,3 A. La tension à ses bornes est U = 20 × 0,3 = 6 V. Si on connaît U et R, on retrouve l'intensité avec I = U/R ; si on connaît U et I, on retrouve la résistance avec R = U/I.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple de calcul avec la puissance électrique P = U × I : une lampe fonctionne sous une tension de 12 V avec une intensité de 0,5 A. Sa puissance est P = 12 × 0,5 = 6 W. Si cette lampe fonctionne pendant 3 heures, l'énergie consommée est E = P × t = 6 × 3 = 18 Wh, soit 0,018 kWh.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Une molécule est un assemblage de plusieurs atomes liés entre eux : par exemple, la molécule d'eau (formule H₂O) est composée de 2 atomes d'hydrogène et 1 atome d'oxygène, tandis que la molécule de dioxyde de carbone (CO₂) contient 1 atome de carbone et 2 atomes d'oxygène. Le petit chiffre en indice indique le nombre d'atomes de chaque élément présents dans une molécule.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>L'œil fonctionne comme un appareil photo : la cornée et le cristallin (une lentille souple) font converger la lumière pour former une image nette sur la rétine, qui transmet ensuite l'information au cerveau par le nerf optique. L'accommodation est la capacité du cristallin à changer de forme (plus bombé de près, plus plat de loin) pour garder une image nette selon la distance de l'objet observé — cette capacité diminue avec l'âge, ce qui explique la presbytie.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Le corps humain, surtout mouillé, devient un bon conducteur électrique, ce qui rend l'électricité particulièrement dangereuse près de l'eau (salle de bain, pluie) : c'est pourquoi il ne faut jamais toucher un appareil électrique avec les mains mouillées. Règles de sécurité essentielles : ne jamais toucher un fil dénudé, couper le courant avant toute intervention sur une installation, et ne jamais surcharger une même prise avec trop d'appareils.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Dans un circuit en série, l'intensité est la même en tout point du circuit (loi d'unicité de l'intensité) ; dans un circuit en dérivation, l'intensité qui sort du générateur se répartit entre les branches, et l'intensité totale est égale à la somme des intensités de chaque branche (loi d'additivité). Exemple : si deux lampes en dérivation sont traversées chacune par 0,2 A, l'intensité totale délivrée par le générateur est 0,2 + 0,2 = 0,4 A.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Sur un oscilloscope, le courant continu (celui d'une pile) apparaît comme une ligne droite horizontale, car sa valeur ne change jamais de sens ni d'intensité au cours du temps. Le courant alternatif (celui du secteur) apparaît comme une courbe sinusoïdale qui oscille régulièrement entre des valeurs positives et négatives, changeant de sens à intervalles réguliers — 50 fois par seconde en Côte d'Ivoire (50 Hz).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Pour identifier un ion présent dans une solution, on utilise des réactifs spécifiques qui forment un précipité coloré caractéristique. Exemple : pour détecter la présence d'ions chlorure (Cl⁻), on ajoute une solution de nitrate d'argent (AgNO₃) : un précipité blanc qui noircit à la lumière se forme si des ions chlorure sont présents, confirmant leur existence dans la solution testée.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>L'échelle de pH va de 0 à 14 : une solution acide a un pH inférieur à 7 (plus le nombre est petit, plus elle est acide), une solution neutre a un pH égal à 7 (comme l'eau pure), et une solution basique a un pH supérieur à 7. On mesure le pH avec du papier pH (qui change de couleur selon une échelle de référence) ou avec un indicateur coloré comme le bleu de bromothymol (BBT), qui devient jaune en milieu acide, vert en milieu neutre et bleu en milieu basique.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple d'équilibrage d'une équation chimique : pour la combustion du carbone, C + O₂ → CO₂ est déjà équilibrée (1 atome de C et 2 atomes de O de chaque côté). Mais pour la combustion de l'hydrogène, 2H₂ + O₂ → 2H₂O est nécessaire pour équilibrer : à gauche, 4 atomes de H et 2 atomes de O ; à droite, 2 molécules d'eau contiennent aussi 4 atomes de H et 2 atomes de O. On ajuste toujours les grands nombres devant les formules, jamais les indices à l'intérieur d'une formule.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>La couleur perçue d'un objet dépend à la fois de la lumière qui l'éclaire et de la lumière qu'il diffuse vers notre œil : un objet rouge éclairé en lumière blanche absorbe toutes les couleurs sauf le rouge, qu'il renvoie vers notre œil. Sous une lumière colorée différente, un objet peut donc changer d'apparence : un tissu rouge éclairé uniquement en lumière verte apparaîtra presque noir, car il n'y a pas de rouge dans cette lumière à diffuser.</p>`,
      quiz: [
  ...
  lessons: [
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>L'islam a joué un rôle central dans ces empires : diffusé par les marchands le long des routes commerciales, il a favorisé le développement de grands centres d'enseignement, comme la célèbre université coranique de Sankoré à Tombouctou, où des milliers de manuscrits scientifiques et religieux ont été rédigés et conservés. Exemple de chronologie simplifiée : l'Empire du Ghana (vers les 8e-11e siècles) précède l'Empire du Mali (13e-15e siècles, avec le célèbre roi Kankou Moussa), lui-même suivi par l'Empire Songhaï (15e-16e siècles).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Face à la traite négrière, des résistances existèrent dès le départ : révoltes à bord des navires négriers, fuites d'esclaves marrons dans les colonies, et mouvements abolitionnistes en Europe et en Amérique au 18e-19e siècle. La traite négrière transatlantique a eu des conséquences démographiques et économiques considérables sur le continent africain, en privant certaines régions d'une grande partie de leur population active pendant plusieurs siècles.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Les puissances coloniales ont utilisé deux grandes méthodes d'administration : l'administration directe (les colonisateurs gouvernent eux-mêmes, imposent leurs propres lois, comme la France en Côte d'Ivoire) et l'administration indirecte (les colonisateurs s'appuient sur les chefs traditionnels locaux pour gouverner, comme le Royaume-Uni dans plusieurs de ses colonies). Les mouvements de résistance puis les luttes pour l'indépendance, menées par des figures comme Félix Houphouët-Boigny en Côte d'Ivoire, ont abouti à la décolonisation progressive de l'Afrique, surtout à partir des années 1950-1960.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>La Côte d'Ivoire est traversée par un important réseau hydrographique (fleuves Bandama, Comoé, Sassandra, Cavally) qui alimente l'agriculture et l'énergie hydroélectrique du pays. La déforestation liée à l'expansion des cultures (cacao, hévéa) et le changement climatique menacent aujourd'hui la forêt ivoirienne, dont la superficie a fortement diminué depuis l'indépendance — un enjeu majeur pour l'avenir environnemental du pays.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>La population ivoirienne se caractérise par une structure très jeune : une grande majorité de la population a moins de 25 ans, ce qu'on peut visualiser avec une pyramide des âges à base large (beaucoup de jeunes) et un sommet étroit (peu de personnes âgées). Cette jeunesse de la population représente à la fois un potentiel important pour le développement économique futur et un défi (emploi, éducation, santé) pour les autorités du pays.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Exemple concret pour illustrer les trois secteurs avec la filière cacao (produit emblématique de la Côte d'Ivoire, premier producteur mondial) : le secteur primaire correspond à la culture et la récolte des fèves de cacao par les planteurs, le secteur secondaire correspond à leur transformation (broyage, fabrication de pâte de cacao, de chocolat) dans des usines, et le secteur tertiaire correspond à leur commercialisation et leur exportation vers les marchés internationaux. La Côte d'Ivoire cherche à transformer une part croissante de son cacao localement plutôt que de l'exporter brut, pour créer plus de valeur et d'emplois sur place.</p>`,
      quiz: [
  ...
  lessons: [
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Chez la femme, un ovule est libéré environ une fois par mois lors de l'ovulation (cycle menstruel d'environ 28 jours) ; s'il rencontre un spermatozoïde lors d'un rapport sexuel, la fécondation peut avoir lieu, donnant naissance à un embryon qui se développe ensuite dans l'utérus pendant environ 9 mois (la gestation) jusqu'à la naissance. La puberté prépare justement le corps à cette capacité de reproduction, avec l'apparition des règles chez la fille et la production de spermatozoïdes chez le garçon.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Le trajet des aliments suit un ordre précis : la bouche (mastication + salive, première digestion des glucides), l'œsophage (simple passage vers l'estomac), l'estomac (brassage + suc gastrique très acide qui digère les protéines), puis l'intestin grêle (où le suc pancréatique et la bile terminent la digestion, et où les nutriments passent dans le sang à travers la paroi intestinale), et enfin le gros intestin (absorption de l'eau et formation des déchets non digérés, évacués sous forme de selles).</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>La respiration se fait grâce à des mouvements mécaniques : lors de l'inspiration, le diaphragme (un muscle situé sous les poumons) se contracte et s'abaisse, ce qui agrandit la cage thoracique et fait entrer l'air ; lors de l'expiration, le diaphragme se relâche et remonte, ce qui réduit le volume de la cage thoracique et chasse l'air chargé de dioxyde de carbone vers l'extérieur. Ce mouvement se répète environ 12 à 20 fois par minute au repos chez un adolescent.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Le sang est composé d'un liquide, le plasma (qui transporte les nutriments, déchets et hormones), et de cellules : les globules rouges (transportent le dioxygène grâce à l'hémoglobine, donnent la couleur rouge au sang), les globules blancs (défendent l'organisme contre les infections) et les plaquettes (permettent la coagulation en cas de blessure, pour arrêter un saignement). Ces quatre composants circulent en permanence dans les vaisseaux sanguins grâce aux battements du cœur.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Un neurone (cellule nerveuse) est constitué d'un corps cellulaire, de courtes ramifications appelées dendrites (qui reçoivent l'information) et d'un long prolongement appelé axone (qui transmet l'information sous forme d'un signal électrique appelé influx nerveux) jusqu'au neurone suivant ou jusqu'à un muscle. C'est cette chaîne de neurones connectés qui permet au cerveau de recevoir des informations sensorielles et d'envoyer des ordres moteurs à travers tout le corps, en quelques millisecondes seulement.</p>`,
      quiz: [
    ...
    },
    {
      ...
      <h3>📝 Explication détaillée et exemple corrigé</h3>
      <p>Dans un écosystème, on distingue trois grands rôles : les producteurs (les végétaux, qui fabriquent leur propre matière organique grâce à la photosynthèse), les consommateurs (les animaux, qui se nourrissent d'autres êtres vivants — consommateurs primaires herbivores, secondaires carnivores, etc.) et les décomposeurs (bactéries, champignons, qui décomposent la matière morte et la restituent au sol sous forme de nutriments réutilisables par les végétaux). Cette organisation en pyramide alimentaire explique pourquoi il y a toujours beaucoup plus de producteurs que de grands prédateurs au sommet de la chaîne.</p>`,
      quiz: [
